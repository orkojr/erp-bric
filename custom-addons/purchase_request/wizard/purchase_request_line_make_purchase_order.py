...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    @api.model
    def _prepare_purchase_order(self, picking_type, group_id, company, origin, service, objet, motif, lieu, vehicule, purchase_request):
        ...
        for item in self.item_ids:
            ...
            if not purchase:
                po_data = self._prepare_purchase_order(
                    ...
                    line.company_id,
                    line.origin,
                    line.request_id.service_id,
                    line.request_id.objet,
                    line.request_id.motif_achat,
                    line.request_id.lieu,
                    line.request_id.vehicule,
                    item.request_id,
