...
class StockReport(models.TransientModel):
    ...
    category = fields.Many2many('product.category', 'categ_wiz_rel1', 'categ', 'wiz', string='Warehouse', domain="[('name', 'in', ['Produits finis','Produits finis / Briqueterie','Produits finis / Tuilerie','Prefa'])]")
    ...
    def get_lines(self, data, warehouse, deb, fin, select_period):
        ...
        if categ_id:
            ...
            categ_products = self.env['product.product'].search([('product_tmpl_id.detailed_type', '=', 'product'),('categ_id.name', 'in', ['Produits finis','Produits finis / Briqueterie','Produits finis / Tuilerie','Prefa'])])
