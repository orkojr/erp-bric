    ...
    def get_xlsx_report(self, data, response):
        ...
        if data['type'] == 'heb':
            ...
            for mat in mat_obj :
                ...
                if len(lundi_line) >0 :
                    for inf in lundi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': 0}
                        if inf['cle'] == mat.id:
                            print("Bjr")
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
                            obj1['mainreq'] = inf['val']['obj']['mainreq']
                            obj1['maintemp'] = inf['val']['obj']['maintemp']
                            obj1['qty'] = inf['val']['qty']
                            total_mat += inf['val']['qty']
                        lun_info.append(obj1)
                
                if len(mardi_line) >0 :
                    for inf in mardi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': ''}
                        if inf['cle'] == mat.id:
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
                            obj1['mainreq'] = inf['val']['obj']['mainreq']
                            ...
                            obj1['qty'] = inf['val']['qty']
                            total_mat += inf['val']['qty']
                        mar_info.append(obj1)
                if len(mercredi_line) >0:
                    for inf in mercredi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': ''}
                        if inf['cle'] == mat.id:
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
                            ...
                            obj1['qty'] = inf['val']['qty']
                            total_mat += inf['val']['qty']
                        mer_info.append(obj1)
                if len(jeudi_line) >0:
                    for inf in jeudi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': ''}
                        if inf['cle'] == mat.id:
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
                            ...
                            obj1['qty'] = inf['val']['qty']
                            total_mat += inf['val']['qty']
                        jeu_info.append(obj1)
                if len(vendredi_line) > 0:
                    for inf in vendredi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': ''}
                        if inf['cle'] == mat.id:
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
                            ...
                            obj1['qty'] = inf['val']['qty']
                            total_mat += inf['val']['qty']
                        ven_info.append(obj1)
                if len(samedi_line) >0:
                    for inf in samedi_line:
                        obj1 = {'produit': '','objectif' : '', 'maintemp' : '','mainreq' : '', 'qty': ''}
                        if inf['cle'] == mat.id:
                            obj1['produit'] = inf['val']['obj']['produit']
                            obj1['objectif'] = inf['val']['obj']['objectif']
            ...
            print(lines_obj)
            for obj in lundi_line:
                print(obj['val']['obj']['produit'])
                print(lundi_line)
            ...
            if len(lundi_obj) > 0:
                coll = len(lundi_obj)
            sheet.merge_range(8,0,8,coll, "Lundi", header_style)
            # sheet.write(8,col, "Lundi", header_style)
            coll += 1
            if len(mardi_obj) > 0 :
                coll -= 1
                coll += len(mardi_obj)
            sheet.merge_range(8,coll,8,coll +1, "Mardi", header_style)
